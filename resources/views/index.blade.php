...
@section( 'content' )
	...
	<div class="container">
		<div class="row text-2xl">
			<div class="col p-2 border border-right-0"><strong><h5>Title</strong></h5></div>
			<div class="col-6 p-2 border border-right-0"><strong><h5>Description</strong></h5></div>
			<div class="col p-2 border border-right-0"><strong><h5>Status</strong></h5></div>
			<div class="col p-2 border"><strong><h5>Actions</strong></h5></div>
		</div>
